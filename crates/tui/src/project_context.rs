//! Project context loading for Token Harbor.
//!
...
fn auto_generate_context(workspace: &Path) -> Option<String> {
    ...
    let content = format!(
        "# Project Structure (Auto-generated)\n\n\
         > This file was automatically generated by Token Harbor.\n\
...
This file provides guidance to AI agents (Token Harbor, Claude Code, etc.) when working with code in this repository.
