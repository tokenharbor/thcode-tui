...
//! `github.com/tokenharbor/thcode-tui/releases/latest`, downloads the
...
const LATEST_RELEASE_URL: &str = "https://api.github.com/repos/tokenharbor/thcode-tui/releases/latest";
